...
Future<void> addStudentDialog(BuildContext context,String classId,String subject,String title,String firstButton,String secondButton,) async {
                ...
                Row(
                  ...
                  children: [
                    CustomRoundButton(
                        ...
                        color: AppColors.kThemePinkColor,
                        onPress: () {
                          AddStudentsController().addStudentToClass(classId, subject, student.text, registration.text).then((value) {
                            student.clear();
                            registration.clear();
                          });
                        }),
